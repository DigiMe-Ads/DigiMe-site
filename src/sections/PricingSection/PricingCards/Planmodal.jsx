    ...
    try {
      const res = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject:    `Plan Enquiry — ${plan.name} (${plan.price}) from ${form.name}`,
          name:       form.name,
          email:      form.email,
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div>
            ...
            <h3 style={{
              ...
              {plan.name}{' '}
              <span style={{ color: '#0f911e', fontWeight: 400, fontStyle: 'italic' }}>
                Plan
              </span>
            </h3>
          </div>
        ...
        <div
          ...
          style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '28px 36px' }}
        >
          <InputField
            label="Full Name *"
