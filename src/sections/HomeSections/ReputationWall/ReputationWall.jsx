...
const STYLES = `
  ...
  /* ── Mobile landscape / large phone (501–768px) ── */
...
export default function ContentWall() {
  ...
  return (
    ...
    >
      ...
      {/* VIEW MORE parallax text — hidden on mobile via CSS */}
      <div
        ref={vmRef}
        aria-hidden="true"
      ...
      {/* Torus — hidden on mobile via CSS */}
      <canvas
        ref={torusRef}
        aria-hidden="true"
        className="wwa-torus"
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
          <svg width="10" height="10" viewBox="0 0 24 24" fill="rgba(255,107,107,0.8)" stroke="none">
